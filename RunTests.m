...
for n = 1:params.nRepeats
    ...
    [scores.ICA_DR.P(:,n), scores.ICA_DR.A(:,n), scores.ICA_DR.cP(:,n), ...
        scores.ICA_DR.cA(:,n)] = calculateDecompositionAccuracy( ...
        P, icadrP, A, icadrA, params);
    ...
    [scores.PROFUMO.P(:,n), scores.PROFUMO.A(:,n), scores.PROFUMO.cP(:,n), ...
        scores.PROFUMO.cA(:,n)] = calculateDecompositionAccuracy( ...
        P, pfmP, A, pfmA, params);
