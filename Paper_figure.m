...
save('Results/Paper_figure_results.mat','Signs','Orders','GroupMaps',...
...
subplot(3,2,1);
histogram(Tcorrs(:,:,2,:),50,'edgecolor','none','facecolor','g','facealpha',0.4); hold on;
histogram(Tcorrs(:,:,3,:),50,'edgecolor','none','facecolor','b','facealpha',0.4);
histogram(Tcorrs(:,:,4,:),50,'edgecolor','none','facecolor','k','facealpha',0.4);
histogram(Tcorrs(:,:,1,:),50,'edgecolor','none','facecolor','r','facealpha',0.4);
legend({'Traditional ICA-DR','Thresholded ICA-DR noO','Thresholded ICA-DR withO','PROFUMO'},'Location','NorthWest')
...
subplot(3,2,2);
histogram(Scorrs(:,:,2,:),50,'edgecolor','none','facecolor','g','facealpha',0.4); hold on;
histogram(Scorrs(:,:,3,:),50,'edgecolor','none','facecolor','k','facealpha',0.4);
histogram(Scorrs(:,:,1,:),50,'edgecolor','none','facecolor','r','facealpha',0.4);
...
subplot(3,2,3);
histogram(Tnets_subs(:,2,:),50,'edgecolor','none','facecolor','g','facealpha',0.4); hold on;
histogram(Tnets_subs(:,3,:),50,'edgecolor','none','facecolor','b','facealpha',0.4);
histogram(Tnets_subs(:,4,:),50,'edgecolor','none','facecolor','k','facealpha',0.4);
histogram(Tnets_subs(:,1,:),50,'edgecolor','none','facecolor','r','facealpha',0.4);
%legend({'Traditional ICA-DR','Thresholded ICA-DR','PROFUMO'})
...
subplot(3,2,4);
histogram(Snets_subs(:,2,:),50,'edgecolor','none','facecolor','g','facealpha',0.4); hold on;
histogram(Snets_subs(:,3,:),50,'edgecolor','none','facecolor','k','facealpha',0.4);
histogram(Snets_subs(:,1,:),50,'edgecolor','none','facecolor','r','facealpha',0.4);
%legend({'Traditional ICA-DR','Thresholded ICA-DR','PROFUMO'})
...
boxplot([A1(:) A2(:) A3(:) A5(:) A4(:)]); hold on; hline(0,':k');
set(gca,'xtick',1:5,'xticklabel',{'Ground Truth','Traditional ICA-DR','Thresholded ICA-DR noO','Thresholded ICA-DR withO','PROFUMO'})
title('F. Temporal edges (selected edges only)');
XYrotalabel(50); %ylabel('Edge estimate')

print(gcf,'-dpng','-r300','Results/Paper_figure.png')
