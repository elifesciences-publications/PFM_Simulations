...
for s = 1:S
    ...
    T(:,2)=T(:,2)-T(:,1)*(pinv(T(:,1))*T(:,2)); % force T2 ortho to T1
...
% Save Results
save('ICA_DRtest_NoTempCorr.mat');
...
print('SimulationDR_NoTempCorr_maps','-dpng','-r150')
...
print('SimulationDR_NoTempCorr_comparisons','-dpng','-r150')
